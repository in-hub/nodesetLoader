...
START_TEST(Server_LoadNS0Values) {
    ...
    ck_assert_uint_eq(retval, UA_STATUSCODE_GOOD);
    ck_assert(var.type == &UA_TYPES[UA_TYPES_SERVERSTATUSDATATYPE]);
    ...
    ck_assert_uint_eq(retval, UA_STATUSCODE_GOOD);
    ck_assert(var.type == &UA_TYPES[UA_TYPES_LOCALIZEDTEXT]);
...
START_TEST(EnumValues)
{
    ...
    ck_assert_uint_eq(retval, UA_STATUSCODE_GOOD);
    ck_assert(var.type == &UA_TYPES[UA_TYPES_ENUMVALUETYPE]);
